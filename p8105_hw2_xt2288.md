...
as the header. The dataset has 487 observations and 6 variables. There
...
dataset, and 16 observations appear in only the amyloid dataset.
...
The combined dataset has 471 observations and 11 variables. The
