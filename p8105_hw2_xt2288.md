...
as the header. The dataset has 487 observations and 6 variables.
...
By using anti_join(), 8 observations appear in only the baseline or
amyloid datasets.
...
The combined dataset has 471 observations and 11 variables.
